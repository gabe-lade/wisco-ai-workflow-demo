...
2. **Claude plans** — Proposes approach
3. **You review** — Approve or refine
4. **Claude implements** — Works autonomously
5. **Verify & commit** — Quality checked
:::

::: {.column width="50%"}
**Why it works:**

- Catches wrong approaches *before* 500 lines of code
- You stay in control of key decisions
- Claude works autonomously on approved plans
:::
